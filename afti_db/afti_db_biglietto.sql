...
CREATE TABLE `biglietto` (
  ...
  CONSTRAINT `fk_biglietto_prenotazione` FOREIGN KEY (`id_prenotazione`) REFERENCES `prenotazione` (`id_prenotazione`) ON DELETE CASCADE
...
INSERT INTO `biglietto` VALUES (1,1,89.90),(2,2,29.90),(3,3,14.50);
